...
mutation createOperatingAgreement($entityName: String!, $businessType: String!, $ownership: String!, $initialMembers: [String]!, $articlesFiled: Boolean, $dateFiled: String, $stateFiled: String, $management: String!, $fiscalYearStart:[Int]!, $fiscalYearEnd: [Int]!, $sharesA: Int, $sharesB: Int, $shares: Boolean, $shareSize: Int, $votingMechanism: String!) {
  createOperatingAgreement(name: $entityName, businessType: $businessType, ownership: $ownership, initialMembers: $initialMembers, articlesFiled: $articlesFiled, dateFiled: $dateFiled, stateFiled: $stateFiled, management: $management, fiscalYearStart: $fiscalYearStart, fiscalYearEnd: $fiscalYearEnd, sharesA: $sharesA, sharesB: $sharesB, createShares: $shares, sizeOfShares: $shareSize, votingMech: $votingMechanism){
      _id
      name
  }
}`